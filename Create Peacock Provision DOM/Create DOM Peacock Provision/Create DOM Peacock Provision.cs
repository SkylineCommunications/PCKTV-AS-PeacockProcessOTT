...
public class Script
{
    ...
    public class SectionDefinitions
    {
        ...
        public static SectionDefinition CreateProvisionInfoServiceDefinition(DomHelper domHelper, ref FieldDescriptorID nameDescriptor)
        {
            ...
            var provisioningTypeFieldDescriptor = CreateFieldDescriptorObject<string>("Provisioning Type (Peacock)", "The type of this provision");
    ...
    public class BehaviorDefinitions
    {
        ...
        private static List<DomStatusSectionDefinitionLink> GetStatusLinks(List<SectionDefinition> sections)
        {
            ...
            var errorStatusLinks = StatusSectionDefinitions.GetSectionDefinitionLinks(sections, fieldsList, "error");
            var activeWithErrorsStatusLinks = StatusSectionDefinitions.GetSectionDefinitionLinks(sections, fieldsList, "active_with_errors");

            var allStatusLinks = new List<DomStatusSectionDefinitionLink>();
            allStatusLinks.AddRange(draftStatusLinks);
            allStatusLinks.AddRange(readyStatusLinks);
            allStatusLinks.AddRange(inprogressStatusLinks);
            allStatusLinks.AddRange(activeStatusLinks);
            allStatusLinks.AddRange(deactivateStatusLinks);
            allStatusLinks.AddRange(deactivatingStatusLinks);
            allStatusLinks.AddRange(completeStatusLinks);
            allStatusLinks.AddRange(reprovisionStatusLinks);
            allStatusLinks.AddRange(errorStatusLinks);
            allStatusLinks.AddRange(activeWithErrorsStatusLinks);

            return allStatusLinks;
        }
